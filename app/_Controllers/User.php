...
class User extends BaseController {
	...
	public function lostform() {
		...
		try {
			...
			Hai richiesto il recupero della tua password: ".$row->pwd."<br><br>
		...
		$datal['msg'] = 'Ti abbiamo inviato una email per il recupero della password';
		return view('login',$datal);
