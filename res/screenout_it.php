...
//aggiungi in respint
$query_aggResp= "INSERT INTO t_respint (sid, uid, status, iid, prj_name) values  ('".$prjId."', '".$userId."', '4','9999','CINTPANEL')";
$aggiungiResp = mysqli_query($admin,$query_aggResp);
...
$livelloprecedente=$lvl['field_user_level_value'];
													...
													<table width="100%" border="0" cellspacing="0" cellpadding="0">
														<tr>
															...
															<td class="text" style="color:#575556; font-family:Verdana; font-size:15px; text-align:left" valign="top">
																	...
																	Ci dispiace, purtroppo il tuo profilo non è adatto a questa ricerca,
																	ma non preoccuparti quanto prima sarai contattato per partecipare ad una nuova ricerca!
															</div>	
															
														<form id="myForm" action="screenout_final.php" method="POST">
													...
													<tr><div style="height:20px;"></div></tr>
														<tr>
															<td valign="top" width="170" class="text" style="color:#a1a1a1; font-family:Verdana; font-size:12px; line-height:18px; text-align:left">
																<div class="img" style="font-size:0pt; line-height:0pt; text-align:left"><a href="https://millebytes.com/mydashboard" target="_blank">
																<img src="https://millebytes.com/assets/img/milebytes-logo.jpg" alt="" border="0" width="170" /></a></div>
																...
																<div class="h2" style="color:#575556; font-family:Verdana; font-size:16px; line-height:24px; text-align:left; font-weight:normal"><div><b>Cerca altri sondaggi</b> </div></div>
															...
															<td valign="top" width="170" class="text" style="color:#a1a1a1; font-family:Verdana; font-size:12px; line-height:18px; text-align:left">
																...
																<div style="font-size:0pt; line-height:0pt; height:15px"><img src="http://www.interactive-mr.com/mail/images/empty.gif" width="1" height="15" style="height:15px" alt="" /></div>
																	...
																	<p>&nbsp;</p>
															<div class="leggi">
															<a href="https://millebytes.com/regolamento"/><span style="padding:5px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LEGGI&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
															</div>
																</div>
															</td>
															<td class="img" style="font-size:0pt; line-height:0pt; text-align:left" width="35"></td>
															...
															<div style="color:#575556;">
																	...
																	<p>&nbsp;</p>
															<div class="leggi">
															<a href="https://millebytes.com/faq"/><span style="padding:5px">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LEGGI&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></a>
															</div>
																</div>
															</td>
														</tr>
